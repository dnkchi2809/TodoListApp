    ...
    return (
        <>
            <div className="px-2 py-2 w-full h-full bg-blue-200 rounded-lg border border-blue-200 shadow-xl dark:bg-blue-800 dark:border-blue-700">
                <button className="w-full h-full rounded bg-white flex justify-center items-center py-2" type="button" onClick={onAddTodoClick} data-toggle="tooltip" title="Add new Todo">
