...
function DeleteTodoModal() {
  ...
  }, [openModalDeleteTodo, resetIsShowing]);
  return (
    <>
      {/*Modal*/}
      <div
        ref={deleteModal}
        tabIndex={-1}
        className="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full flex justify-center items-center inset-0 bg-gray-200 bg-opacity-60 transition-opacity"
      >
